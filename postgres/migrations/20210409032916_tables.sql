...
-- for example
-- CREATE TABLE IF NOT EXISTS block_0 PARTITION OF block FOR VALUES FROM (0) TO (100);
-- CREATE TABLE IF NOT EXISTS block_1 PARTITION OF block FOR VALUES FROM (100) TO (200);
-- CREATE TABLE IF NOT EXISTS block_2 PARTITION OF block FOR VALUES FROM (200) TO (300);
-- CREATE TABLE IF NOT EXISTS block_3 PARTITION OF block FOR VALUES FROM (300) TO (400);
-- CREATE TABLE IF NOT EXISTS block_4 PARTITION OF block FOR VALUES FROM (400) TO (500);
-- CREATE TABLE IF NOT EXISTS block_5 PARTITION OF block FOR VALUES FROM (500) TO (600);
-- CREATE TABLE IF NOT EXISTS block_6 PARTITION OF block FOR VALUES FROM (600) TO (700);
-- CREATE TABLE IF NOT EXISTS block_7 PARTITION OF block FOR VALUES FROM (700) TO (800);
-- CREATE TABLE IF NOT EXISTS block_8 PARTITION OF block FOR VALUES FROM (800) TO (900);
-- CREATE TABLE IF NOT EXISTS block_9 PARTITION OF block FOR VALUES FROM (900) TO (1000);
